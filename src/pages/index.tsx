                            ...
                            isAuth ? (
                                <>
                                    <Route  element={<Layout/> }>
                                        ...
                                        <Route path="newSupplierTransaction/:id" element={<NewSupplierTransaction/>}/>
                                        <Route path="newSupplierPayment/:id" element={<NewSupplierPayment/>}/>
                                        <Route path="notFound" element={<NotFound/>}/>
                                        <Route path="customersList" element={<CustomersList/>}/>
                                        <Route path="createCustomerInvoice" element={<CreateCustomerInvoice/>}/>
                                        <Route path="editCustomerInvoice" element={<EditCustomerInvoice/>}/>
