...
import { deleteSupplier } from "@/lib/apiCalls/supplierAPIs";
...
const SupplierInfo = ({
  ...
  return (
    <div className="w-full mx-auto  rounded-lg overflow-hidden border-4 border-gray-50 hover:bg-gray-50">
      <div className="p-4">
        ...
        <div className=" flex flex-col md:flex-row justify-center items-center gap-3 text-sm text-gray-600">
          ...
          <p>
            <strong>Cash Balance:</strong> ${supplier?.cashBalance}
          </p>
          <p>
            <strong>Ramli Balance:</strong> {supplier?.ramliBalance}
          </p>
          <p>
            <strong>Silver Balance:</strong> {supplier?.silverBalance}
          </p>
          <p>
            <strong>Created Date:</strong> {supplier?.createdDate}
          </p>
        </div>
      </div>
