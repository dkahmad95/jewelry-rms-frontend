...
import {
    addExpensesFailure,
    addExpensesStart, addExpensesSuccess, deleteExpensesFailure, deleteExpensesStart, deleteExpensesSuccess,
    getExpensesFailure,
    getExpensesStart,
    getExpensesSuccess, getOneExpenseFailure,
    getOneExpenseStart,
    getOneExpenseSuccess, updateExpensesFailure, updateExpensesStart, updateExpensesSuccess
} from "@/lib/redux/expensesRedux";
import {CreateExpenses, UpdatedExpenses} from "@/lib/interfaces/expenses-interface";
...
// Add New Expense
export const createExpense = async (dispatch : Dispatch, expenses : CreateExpenses)=>{
...
export const updateExpense = async (newExpense : UpdatedExpenses, id : number ,dispatch: Dispatch) => {
